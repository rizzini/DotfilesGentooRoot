...
SRC_URI="https://download.tuxera.com/opensource/${MY_P}.tgz
		https://aur.archlinux.org/cgit/aur.git/snapshot/ntfsprogs-ntfs3.tar.gz"
...
# 		fi
	...
	dobin ${WORKDIR}/ntfsprogs-ntfs3/mount.ntfs
	insinto /lib/udev/rules.d/
	newins ${WORKDIR}/ntfsprogs-ntfs3/udisks_ntfs3_mount_options.rules 50-ntfs3-ntfsprogs.rules
}
pkg_postinst() {
	udev_reload
}
